                                ...
                                <div class="wishlist-card">
                                    <div class="wishlist-card-body">
                                        <div class="wishlist-product-card">
                                            <figure>
                                                <a href="{{route('front.product.details',$item->productDetails->slug)}}"><img src="{{asset($item->productDetails?$item->productDetails->image:'')}}"></a>
                                            </figure>
                                            <figcaption>
                                                <h6>{{$item->productDetails?$item->productDetails->style_no:""}}</h6>
                                                <h4><a href="{{route('front.product.details',$item->productDetails->slug)}}">{{$item->productDetails?$item->productDetails->name:""}}</a></h4>
                                                <h5>
